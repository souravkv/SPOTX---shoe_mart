    ...
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <h1 className="mt-10 text-8xl font-palanquin max-sm:text-[72px] max-sm:leading-[82px] font-bold">
          ...
          <br />
          <span className="text-coral-red inline-block mt-3">Omni</span> Shoes
        </h1>
      ...
      <div className="flex-1 flex justify-center items-center  xl:min-h-screen max-xl:py-40 bg-hero bg-primary bg-cover bg-center">
        ...
        <div className="flex sm:gap-6 gap-4 absolute -bottom-[10%] sm:right-[10%] max-xl:hidden max-sm:px-6 ">
          {shoes.map((shoe) => (
            <div key={shoe}  className="cursor-pointer max-w-xs transition duration-300 ease-in-out hover:scale-110 ">
              <ShoeCard
                imgURL={shoe}
